...
define(["require", "exports", "./Abstract/Widget"], function(require, exports, widget) {
    ...
    */
    var SumWidget = (function (_super) {
        __extends(SumWidget, _super);
        function SumWidget() {
            _super.apply(this, arguments);
        }
        SumWidget.prototype.set = function (value) {
            var elem = this.rootElement, path = elem.data('path'), sum = 0, i, splitPath = path.split("."), tmp, formatter, sumPrefix;
            ...
            _super.prototype.set.call(this, sum);
        };

        SumWidget.prototype.findValue = function (item, path) {
            var i, value = item;
